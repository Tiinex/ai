...
- Do not let a same-pass helpful rewrite become new governance, new canon, or "gäller framåt" logic without separate validation.
...
- If a persistence gate is not satisfied, do not format the result as active policy, standing logic, canon, or rules "som gäller framåt".
...
- Do not use headings or phrases like "Stående styrlogik", "gäller framåt", "policy", or "regler" for fresh-read output unless the persistence gate is already satisfied.
